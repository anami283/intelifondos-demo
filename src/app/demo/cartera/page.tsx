...
export default function CarteraPage() {
  ...
  return (
        <>
              <Header title="Gestion de Cartera" subtitle={`${cartera.activos} creditos activos - ICV ${cartera.icv}%`} breadcrumb="Cartera" />
              <div className="p-5 lg:p-6 space-y-6">
                ...
                {/* KPIs cartera */}
                      <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
                                ...
                                <KPICard title="Mora +30 dias" value={cartera.mora_mas30} format="cop" color="rojo" icon={<TrendingDown className="w-5 h-5" />} />
                                            ...
                                            <table className="w-full text-sm">
                                                          <thead style={{ background: "#f8fafc" }}>
                                                                          <tr className="text-left text-[10px] font-semibold uppercase tracking-wider" style={{ color: "#94a3b8" }}>
                                                                                            <th className="px-3 py-2.5">ID Credito</th>th>
                            ...
                            <tr key={c.id} className="hover:bg-slate-50 transition-colors">
                                                ...
                                                <td className="px-3 py-3">
                                                                      <span
                                                                                                ...
                                                                                                style={{ color: c.dias_mora === 0 ? "#059669" : c.dias_mora < 30 ? "#d97706" : c.dias_mora < 60 ? "#ea580c" : "#dc2626" }}
                                                                                              >
                                                                        {c.dias_mora}
                                                                      </span>span>
                                                </td>td>
                      ...
                      <div className="bg-white rounded-2xl p-5" style={{ border: "1px solid rgba(226,232,240,0.8)", boxShadow: "0 1px 4px rgba(0,0,0,0.04)" }}>
                                <div className="flex items-center justify-between mb-4">
                                            ...
                                            <button
                                                            ...
                                                            style={{ background: generando ? "#94a3b8" : "#0A2540" }}
                                                          >
